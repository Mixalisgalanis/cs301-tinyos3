...
/*
   Needs a cause and returns a priority number
 */
...
/*
   Implements an anti_aging_policy which prevents starvation of threads that are
   waiting a long time to be executed
 */
