...
typedef struct thread_control_block {
...
#ifndef NVALGRIND
  unsigned valgrind_stack_id; /**< This is useful in order to register the
                                 thread stack to valgrind */
#endif
  ...
  TimerDuration wakeup_time; /**< The time this thread will be woken up by the
                                scheduler */
